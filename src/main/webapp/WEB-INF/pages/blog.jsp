                ...
                <div class="col-lg-8 mb-5 mb-lg-0">
                    <div class="blog_left_sidebar">
                        <article class="blog_item">
                            <div class="blog_item_js">
                                <js class="card-js rounded-0" src="static/js/blog/single_blog_1.png" alt="">
                        ...
                        <article class="blog_item">
                            <div class="blog_item_js">
                                <js class="card-js rounded-0" src="js/blog/single_blog_2.png" alt="">
                                <a href="#" class="blog_item_date">
                                    <h3>15</h3>
                                    <p>Jan</p>
                                </a>
                        ...
                        <article class="blog_item">
                            <div class="blog_item_js">
                                <js class="card-js rounded-0" src="static/js/blog/single_blog_3.png" alt="">
                                <a href="#" class="blog_item_date">
                                    <h3>15</h3>
                                    <p>Jan</p>
                                </a>
                        ...
                        <article class="blog_item">
                            <div class="blog_item_js">
                                <js class="card-img rounded-0" src="static/img/blog/single_blog_4.png" alt="">
                                <a href="#" class="blog_item_date">
                                    <h3>15</h3>
                                    <p>Jan</p>
                                </a>
